...
#         self.assertEqual(letter_for_person_with_legacy_ls_date.person.has_been_served, True)
#         self.assertEqual(letter_for_person_with_legacy_ls_date.person.last_served, self.now)
#
